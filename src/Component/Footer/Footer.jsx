...
const Footer = () => {
   ...
   <nav>
     ...
     <a className="link  text-white link-hover">Collins Street West, Victoria 8007, Australia.</a>
     <a className="link   text-white link-hover">+1 246-345-0695</a>
     <a className="link   text-white link-hover flex gap-1 "><MdEmail  className="text-lg" />   Nesthub09@gmail.com</a>
 ...
 <footer className="footer  px-10 py-4 border  bg-indigo-500 text-base-content border-base-300">
   <aside className="items-center grid-flow-col">
     ...
     <p>NestQuestHub Industries Ltd. <br/>Providing reliable tech since 1992</p> 
   </aside> 
